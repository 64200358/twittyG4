        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-8">
                                <p><strong><h2 class="panel-title">Start Write Here</h2></strong></p>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        <p><strong><h3 class="panel-title">Trending Now</h3></strong></p>
                        </div>
                        <div class="panel-body">
                            <div id="post_list">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        <p><strong><h3 class="panel-title">User List</h3></strong></p>
                        </div>
                        <div class="panel-body">
